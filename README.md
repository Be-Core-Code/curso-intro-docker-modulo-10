...
## Módulo 10: Docker Technology overview
...
```bash
> docker run --rm -p "8010:8010" becorecode/curso-intro-docker-modulo-10:latest
```

Una vez levantado el contenedor, accede con un navegador web a `http://localhost:8010`
